...
class NewsAgent:
    '''
    An object that can distrubute news items from news sources to 
    news destinations.
    '''
    ...
    def distribute(self):
        '''
        Retrieve all news items from all sources, and Distribute
        them to all destinations.
        '''
        items = []
...
class PlainDestination:
    '''
    A news destination that formats all its new items as plain text.
    '''
